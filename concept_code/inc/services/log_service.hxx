...
namespace fireball {
	namespace services {
		...
		public:
			...
			typedef std::variant<int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t, f32_t> value_t;
		...
		private:
			...
			boost::circular_buffer<entry_t, std::pmr::polymorphic_allocator<entry_t>> ringbuffer_;
			uint64_t last_ts_;
