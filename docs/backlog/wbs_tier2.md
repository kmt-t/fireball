...
2. **[Step 1-2] 形式検証 (Formal Verification)**: WIT によるインターフェイス定義、および Alloy による論理不変条件の証明。
...
- **Proof**: `alloy_report.md` (Alloy 検証結果の要約)
