...
正本: [`runtime_vmmio.md`](docs/components/tier2_runtime/runtime_vmmio.md) , [`runtime_interpreter.md`](docs/components/tier2_runtime/runtime_interpreter.md) 参考実装: [`bench_linear_memory.py`](experiments/pysim/benchmarks/linear_memory/bench_linear_memory.py)
