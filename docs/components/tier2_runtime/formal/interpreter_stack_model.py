...
def build_model(*, guards: bool = True) -> Kripke:
    ...
    - s_operand_eval: OperandStack で命令のオペランドを評価
    - s_control_eval: control_frame を独立領域で更新
    ...
    R = [
        ...
        ("s_local_frame", "s_operand_eval"),
        ("s_operand_eval", "s_control_eval"),
        ("s_control_eval", "s_return"),
    ...
    L = {
        ...
        "s_operand_eval": {"operand_stack_active", "call_active"},
        "s_control_eval": {"control_frame_active", "call_active"},
