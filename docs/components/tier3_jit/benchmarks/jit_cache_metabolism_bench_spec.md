...
| **BENCH-METAB-04** | 局所アンリンク & ダングリングチェイン解消 | トレース A $\to$ B チェイン中、B の属するバンクが Oldest 満杯でパージ | アンリンク成功率 (100%), ダングリング参照数 (0件) | Oldest パージ時に被チェイン元 A のリンクが安全にスタブへ復帰解除されること | `jit_runtime.md` (5) |
