...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **BENCHMARK-METAB-01** | Oldest 限定昇格 (Oldest-Only Promotion) 特性 | Warm ヒット vs Oldest ヒット | 昇格コピー数, ヒット率 (%) | Warm ヒット時は昇格せず、Oldest ヒット時のみ Active へ昇格すること | `{JIT_OldestOnly_Promote}` |
