...
- **Copy-and-Patch JIT**: [Copy-and-Patch Compilation (Research Paper)](https://dl.acm.org/doi/10.1145/3485513)
...
- **wasm3**: [GitHub - wasm3/wasm3](https://github.com/wasm3/wasm3) (高速インタープリタの参照)
...
## ハードウェア・OS
- **IEEE Std 1003.1-2017 (POSIX.1)**: [The Open Group Base Specifications Issue 7](https://pubs.opengroup.org/onlinepubs/9699919799/)
- **ARM Cortex-M33**: [ARMv8-M Architecture Reference Manual](https://developer.arm.com/documentation/ddi0553/latest/)
- **RISC-V**: [RISC-V Instruction Set Manual](https://riscv.org/technical/specifications/)
- **Zephyr RTOS**: [Zephyr Project Documentation](https://docs.zephyrproject.org/)
