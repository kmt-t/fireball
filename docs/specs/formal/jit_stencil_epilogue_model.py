...
(1) ダーティな TOS/NOS スタックキャッシュ（R3/R4）が未フラッシュのままトレースを抜けないこと
...
if __name__ == "__main__":
    ...
    print("=== Formal Verification: JIT Stencil Epilogue Model (guards=True) ===")
    ...
    print("=== Mutation Testing: JIT Stencil Epilogue Model (guards=False) ===")
