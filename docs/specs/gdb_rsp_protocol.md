...
| **`1`** | `sp` | 32-bit | `execution_context.sp_offset` (スタックボトムから見た、現在積まれているオペランドスタックの成長長——次の空きスロットへのオフセット。`runtime_interpreter.md` `runtime_interpreter.md`「スタックの成長した長さ」と同一の量) |
