...
class Logger:
    ...
    def __init__(self, transport: UartTransport, dictionary: LogDictionary,

                 min_level: LogLevel = LogLevel.INFO, capacity: int = 16):
    ...
    def log_event(self, level: LogLevel, dict_offset: int,

                   arg0: int = 0, arg1: int = 0, arg2: int = 0, arg3: int = 0) -> str:
        ...
        overwritten = self.ring.push(LogEntry(level, dict_offset, (arg0, arg1, arg2, arg3), self._tick))
