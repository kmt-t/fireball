"""
experiments/pysim/qa/scenarios/scenario12_wasi03p_uri_resolver.py
...
def test_wasi03p_hierarchical_uri_and_ipc_commands():
    ...
    #   Entry 2: Resource Scope, UINT32, key_id=0x14 (BUFFER_HANDLE), val=buffer_handle
    ...
    ipc_msg_64 = IPCMessage.from_entries(pairs, memory_manager=sysv.memory_manager)
