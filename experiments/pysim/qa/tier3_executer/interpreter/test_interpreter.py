...
"""
Unit tests for Tier 3 Executer: WASM Interpreter & Instructions
Traceability: interpreter_test_spec.md, wasm_instruction_set_test_spec.md
"""
...
def test_intp_17_return_publishes_explicit_sentinel_before_frame_pop():
    ...
    from tier3_executer.interpreter.interpreter import RETURN_SENTINEL_IP, RETURN_SENTINEL_PC
