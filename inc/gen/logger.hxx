...
public:
   ...
   */
  void emit(sys_log_level level, uint32_t dict_offset, uint32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3) noexcept;
   ...
   */
  void set_threshold(sys_log_level level) noexcept;
