...
| :--- | :--- | :---: | :---: | :--- | :--- | :--- |
| `components/tier1_core/os_coos.md` | **1. コンセプト** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_core/os_scheduler.md` | **1. コンセプト** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_interface/ipc_router.md` | **6.1 検証対象の不変条件** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_interface/ipc_router.md` | **4.4 内部シーケンス図** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_interface/ipc_router.md` | **サービス検索と接続フロー** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_core/os_coos.md` | **3.1 データ構造** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| `components/tier1_interface/ipc_router.md` | **ロール間通信許可マトリクス (FB_CONF_ROUTER_ROLE_MATRIX)** | 4/5 | **4/5** | `pyModelChecking` | `{VERIFY_FORMAL}` | Stateful concurrent protocol or hardware safety invariant identified |
...
| :--- | :--- | :---: | :---: | :---: | :--- | :--- | :--- |
| `components/tier1_core/os_coos.md` | 1. コンセプト | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for '1. コンセプト'. |
...
| `components/tier1_core/os_scheduler.md` | 1. コンセプト | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for '1. コンセプト'. |
...
| `components/tier1_interface/ipc_router.md` | 6.1 検証対象の不変条件 | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for '6.1 検証対象の不変条件'. |
...
| `components/tier1_interface/ipc_router.md` | 4.4 内部シーケンス図 | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for '4.4 内部シーケンス図'. |
...
| `components/tier1_interface/ipc_router.md` | サービス検索と接続フロー | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for 'サービス検索と接続フロー'. |
...
| `components/tier1_core/os_coos.md` | 3.1 データ構造 | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for '3.1 データ構造'. |
...
| `components/tier1_interface/ipc_router.md` | ロール間通信許可マトリクス (FB_CONF_ROUTER_ROLE_MATRIX) | 1 | 4/5 | 4/5 | `pyModelChecking` | `{VERIFY_FORMAL}` | Independent heuristic evaluation for 'ロール間通信許可マトリクス (FB_CONF_ROUTER_ROLE_MATRIX)'. |
...
| `components/tier2_runtime/runtime_vmmio.md` | アドレスフィールド定義 (vmmio_address) | 2 | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for 'アドレスフィールド定義 (vmmio_address)'. |
...
| `plans/backlog_list.md` | Phase 1.1: WASM 32-bit Binary Loader (`runtime_loader`) | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for 'Phase 1.1: WASM 32-bit Binary Loader (`runtime_loader`)'. |
...
| `requires/requirement_list.md` | 2.1 ユースケース図 | 0 | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for '2.1 ユースケース図'. |
| `plans/roadmap_phase.md` | フェーズ概要 | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for 'フェーズ概要'. |
| `architecture/concept_harness.md` | 4. 設計判断 (ADR) | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for '4. 設計判断 (ADR)'. |
| `plans/roadmap_phase.md` | Phase 1: vSoC First（GO後に約3ヶ月） | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for 'Phase 1: vSoC First（GO後に約3ヶ月）'. |
| `plans/backlog_list.md` | Phase 1.4: Standalone vSoC Harness & WAMR Benchmark (`runtime_vsoc`) | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for 'Phase 1.4: Standalone vSoC Harness & WAMR Benchmark (`runtime_vsoc`)'. |
| `requires/requirement_list.md` | [Template & Meta] | 0 | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for '[Template & Meta]'. |
| `architecture/resource_budget.md` | 4.3 予算追跡（Phase 1 開始後に記録予定） | meta | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for '4.3 予算追跡（Phase 1 開始後に記録予定）'. |
...
| `requires/requirement_list.md` | 2. ユースケース | 0 | 3/5 | 3/5 | `LLM_Judge` | `{VERIFY_LLM}` | Independent heuristic evaluation for '2. ユースケース'. |
...
| `components/tier2_jit/jit_engine_copy_patch.md` | 6.1 性能制約と最優先設計方針 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6.1 性能制約と最優先設計方針'. |
...
| `components/tier2_runtime/runtime_vmmio.md` | L1/L2 ページテーブル定義 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for 'L1/L2 ページテーブル定義'. |
...
| `components/tier2_runtime/runtime_vmmio.md` | 4.2 性能分析（Tier別） | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '4.2 性能分析（Tier別）'. |
...
| `components/tier2_runtime/runtime_vsoc.md` | 6.2 検証対象のプロパティ | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6.2 検証対象のプロパティ'. |
...
| `components/tier3_platform/platform_hal.md` | 5.3 RSPトランスポート構成 | 3 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '5.3 RSPトランスポート構成'. |
...
| `components/tier1_interface/ipc_router.md` | 6.1 性能制約と方策 | 1 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6.1 性能制約と方策'. |
...
| `components/tier2_runtime/runtime_vmmio.md` | 4.4 SYSCTL レジスタ詳細 (FC=12, L2=0) | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '4.4 SYSCTL レジスタ詳細 (FC=12, L2=0)'. |
...
| `components/tier2_runtime/runtime_vmmio.md` | 4.5 VDMA レジスタ詳細 (FC=12, L2=2) | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '4.5 VDMA レジスタ詳細 (FC=12, L2=2)'. |
...
| `components/tier1_core/system_config_details.md` | (Overview) | 1 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '(Overview)'. |
...
| `components/tier2_jit/jit_assembler_constexpr.md` | 6. 制約達成の方策 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6. 制約達成の方策'. |
...
| `components/tier2_jit/jit_compiler.md` | 7. 制約達成の方策 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '7. 制約達成の方策'. |
...
| `components/tier2_jit/jit_engine_copy_patch.md` | 6. 制約達成の方策 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6. 制約達成の方策'. |
...
| `components/tier2_jit/jit_runtime_entry.md` | 6. 制約達成の方策 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6. 制約達成の方策'. |
...
| `components/tier2_jit/jit_runtime_hotspot.md` | 6. 制約達成の方策 | 2 | 2/5 | 2/5 | `Static` | - | Independent heuristic evaluation for '6. 制約達成の方策'. |
