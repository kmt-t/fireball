...
/**
 * stdcxx_allocator.cxx - Global operator new/delete overrides for C++ standard
 * library.
 *
 * This file implements the global operator new/delete functions to redirect all
 * C++ standard library memory allocations to the stdcxx_allocator
 * (specified_allocator). This ensures that all standard library containers and
 * objects use the dedicated host heap partition, enabling fine-grained memory
 * management and isolation from other heap partitions (COOS kernel, WASM
 ...
 *
 * Alignment Support:
 *   - All alignment-aware operator new/delete variants properly forward
 * alignment requirements to the underlying allocator.
 */
