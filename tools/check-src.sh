#!/bin/bash
# Fireball Source Code Quality Gate & Verification Runner (Bash)
...
Usage:
  ./tools/check-src.sh [OPTIONS] [FILES...]

Options:
  -g, --group <name> Source group to verify: cpp, python, concepts, formal, pysim, all (default: all).
